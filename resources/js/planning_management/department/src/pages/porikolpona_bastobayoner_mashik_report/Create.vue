        ...
        <div class="col-sm-12">
            <div class="card w-100">
                <div class="card-header py-1 d-flex align-items-center justify-content-between gap-2">
                    ...
                    <router-link :to="{ name: 'CreateFormporikolpona_bastobayoner_mashik_report' }" class="btn btn-outline-warning btn-sm">Create new row </router-link>
                </div>
                <div class="card-body">
                                ...
                                <tr v-for="(item, index) in data" :key="index">
                                    <td>
                                        <div class="action_btn d-flex gap-2 p-2">
                                            <router-link :to="{ name: 'EditFormBarshikPorikolpona', params: { id: index } }" class="btn btn-sm btn-warning">
